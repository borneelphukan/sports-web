  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-5 rounded-md shadow-lg w-[50%] h-[60%]">
        <Image src={imageUrl} alt="Popup Image" width={300} height={300} className="rounded-md mb-3" />
        <h2 className="text-lg font-bold">Brilliant golf resort in the thracian cliffs</h2>
